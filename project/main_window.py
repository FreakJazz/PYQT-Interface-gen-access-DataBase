...
class Ui_AnalisysCheck(object):
    def setupUi(self, AnalisysCheck):
        ...
        self.ingresar.setGeometry(QtCore.QRect(180, 170, 121, 41))
        ...
        self.Listo = QtWidgets.QLabel(self.centralwidget)
        self.Listo.setGeometry(QtCore.QRect(20, 250, 47, 13))
    ...
    def retranslateUi(self, AnalisysCheck):
        ...
        self.Listo.setText(_translate("AnalisysCheck", "TextLabel"))
